...
public class LocalStorageHandler extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "MobileControl.db";
    private static final int DATABASE_VERSION = 1;
    private static final String _ID = "_id";
    private static final String TABLE_NAME_MESSAGES = "mobile_messages";
    ...
    private static final String TABLE_MESSAGE_CREATE = "CREATE TABLE " + TABLE_NAME_MESSAGES + " (" + _ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + MESSAGE_RECEIVER + " VARCHAR(25), " + MESSAGE_SENDER + " VARCHAR(25), " + MESSAGE_MESSAGE + " VARCHAR(255));";
    ...
    public void insert(String sender, String receiver, String message) {
        ...
        try {
            ...
            rowId = db.insert(TABLE_NAME_MESSAGES, null, contentValues);
